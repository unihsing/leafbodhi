...
( function( $ ) {
	...
	// Primary SubMenu
	astra_color_responsive_css( 'transparent-primary-header', 'astra-settings[transparent-submenu-bg-color-responsive]', 'background-color', '.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-link, .ast-header-break-point.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-link, .ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) [CLASS*="ast-builder-menu-"] .main-header-menu .sub-menu .menu-link, .ast-header-break-point.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) [CLASS*="ast-builder-menu-"] .main-header-menu .sub-menu .menu-link' );
